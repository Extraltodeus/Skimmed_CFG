...
- "Clean Skim": [I prefer less sliders than more.](https://youtu.be/-3_IuPMya6k?si=k_Lv6PHAJ9wbK5n9&t=7) This is what gives the most satisfying results among without limiting the burns so much. It is the same as using the base node "Skimmed CFG" with a scale equal to your sampler and "full skim" toggled on.
